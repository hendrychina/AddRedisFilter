...
import com.axway.filter.RedisKeyExistsCacheUI;

public class RedisKeyExistsCache extends DefaultFilter{
	...
	public Class getMessageProcessorClass() {
		...
		return com.axway.filter.RedisKeyExistsCacheProcessor.class;
	}
	
	public Class getConfigPanelClass() throws ClassNotFoundException {
		return Class.forName("com.axway.filter.RedisKeyExistsCacheUI");						  
	}
}
