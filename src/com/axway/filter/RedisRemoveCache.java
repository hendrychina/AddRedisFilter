...
import com.axway.filter.RedisRemoveCacheUI;

public class RedisRemoveCache extends DefaultFilter{
	...
	public Class getMessageProcessorClass() {
		...
		return com.axway.filter.RedisRemoveCacheProcessor.class;
	}
	
	public Class getConfigPanelClass() throws ClassNotFoundException {
		return Class.forName("com.axway.filter.RedisRemoveCacheUI");
	}
